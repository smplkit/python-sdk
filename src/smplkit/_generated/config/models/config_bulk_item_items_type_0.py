...
T = TypeVar("T", bound="ConfigBulkItemItemsType0")


@_attrs_define
class ConfigBulkItemItemsType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        config_bulk_item_items_type_0 = cls()
        ...
        config_bulk_item_items_type_0.additional_properties = additional_properties
        return config_bulk_item_items_type_0
