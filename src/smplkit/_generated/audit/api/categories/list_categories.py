...
from ...models.list_categories_sort import ListCategoriesSort
from ...types import Unset


def _get_kwargs(
    *,
    sort: ListCategoriesSort | Unset = "key",
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CategoryListResponse | None:
    if response.status_code == 200:
        response_200 = CategoryListResponse.from_dict(response.json())
