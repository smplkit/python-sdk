...
class ForwarderRequest:
    r"""JSON:API request envelope for updating a forwarder.
    ...
    Attributes:
        data (ForwarderResource): JSON:API resource envelope for a forwarder.
            ...
            'headers.DD-API-KEY': 'dd-prod-api-key-plaintext'}}, 'filter': {'==': [{'var': 'event_type'}, 'user.created']},
            'forward_smplkit_events': False, 'forwarder_type': 'datadog', 'name': 'Datadog production', 'transform': '{
            "message": event_type & \' on \' & resource_type }', 'transform_type': 'JSONATA', 'updated_at':
