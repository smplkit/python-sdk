    ...
    `id` must not be specified for create requests (the server assigns it).
        ...
        Example:
            {'attributes': {'actor_id': 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee', 'actor_label': 'alice@example.com',
                ...
                'do_not_forward': False, 'event_type': 'user.created', 'idempotency_key': 'auto-1234abcd', 'occurred_at':
                '2026-05-06T20:00:00Z', 'resource_id': 'u-1', 'resource_type': 'user', 'severity': 'INFO'}, 'id':
