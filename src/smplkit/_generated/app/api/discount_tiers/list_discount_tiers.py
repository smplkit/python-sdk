...
from ...models.discount_tier_list_response import DiscountTierListResponse
from ...models.error_response import ErrorResponse
from ...models.list_discount_tiers_sort import ListDiscountTiersSort
from ...types import Unset


def _get_kwargs(
    *,
    sort: ListDiscountTiersSort | Unset = "products_count",
...
) -> DiscountTierListResponse | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = DiscountTierListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DiscountTierListResponse | ErrorResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        sort (ListDiscountTiersSort | Unset): Field to sort by. Prefix with `-` for descending
            order. Default: `products_count`. Allowed values: `percent_off`, `-percent_off`,
            `products_count`, `-products_count`. Default: 'products_count'.
...
def sync(
    *,
    ...
    Returns:
        DiscountTierListResponse | ErrorResponse
    """
