...
T = TypeVar("T", bound="SSOConnectionRequest")


@_attrs_define
class SSOConnectionRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sso_connection_request = cls(
            data=data,
        )

        sso_connection_request.additional_properties = d
        return sso_connection_request
