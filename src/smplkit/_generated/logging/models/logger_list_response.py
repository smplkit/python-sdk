...
T = TypeVar("T", bound="LoggerListResponse")
...
class LoggerListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = LoggerResource.from_dict(data_item_data)

            data.append(data_item)

        logger_list_response = cls(
            data=data,
        )

        logger_list_response.additional_properties = d
        return logger_list_response
