...
from ...models.list_retry_policies_sort import ListRetryPoliciesSort
from ...models.retry_policy_list_response import RetryPolicyListResponse
...
def _get_kwargs(
    *,
    ...
    sort: ListRetryPoliciesSort | Unset = "name",
...
) -> RetryPolicyListResponse | None:
    if response.status_code == 200:
        response_200 = RetryPolicyListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[RetryPolicyListResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (ListRetryPoliciesSort | Unset): Field to sort by. Prefix with `-` for descending
            order. Default: `name`. Allowed values: `created_at`, `-created_at`, `name`, `-name`,
